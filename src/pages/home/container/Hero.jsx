  ...
  return (
    <section className="container mx-auto flex flex-col px-5 py-5 lg:flex-row">
      <div className="mt-10 lg:w-1/2">
        ...
        A Los Angeles-based singer/songwriter with a dreamy and hook-filled indie pop heart,
         Phoebe Bridgers' witty lyrical perspectives, sadly beautiful songs, and commanding melodies have connected 
